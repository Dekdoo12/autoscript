...
clear;clear;clear
echo -e "${YELLOW}----------------------------------------------------------${NC}"
echo -e "\033[96;1m              WELCOME TO SRICPT BY TUNNELING OFFICIAL             \033[0m"
echo -e "${YELLOW}----------------------------------------------------------${NC}"
echo ""
sleep 3
...
echo -e "\e[32mloading...\e[0m"
clear
izinsc="https://raw.githubusercontent.com/Dekdoo12/izinsc/main/ip"
rm -f /usr/bin/user
...
wget raw.githubusercontent.com/Dekdoo12/autoscript/main/Fls/limit.sh && chmod +x limit.sh && ./limit.sh
cd
